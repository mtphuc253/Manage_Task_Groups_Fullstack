...
import { Calendar, CheckCircle2, Clock, ArrowRight, Loader2, BarChart3, PieChartIcon, TrendingUp, Activity } from 'lucide-react'
...
const UserDashboard = () => {
  ...
  const getDashBoardData = async () => {
    ...
    try {
      // Use user-specific dashboard endpoint
