...
import { Loader2, Paperclip, Users, Clock, CheckCircle2, AlertCircle } from 'lucide-react'
...
const MyTasks = () => {
  ...
  const handleTaskClick = (taskId) => {
    navigate(`/user/task-detail?id=${taskId}`)
  }
    ...
    <DashBoardLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">All your Tasks</h1>
